...
// the code below comes from open3d source code
...
PYBIND11_MODULE(mylib, m)
{
    ...
    m.doc() = "pybind11 FastEigen3x3 plugin";
    // expose add function, and add keyword arguments and default arguments
    m.def("FastEigen3x3", &FastEigen3x3, "A function which performs fast 3x3 matrix eigenvectors computation");
