...
if __name__ == '__main__':
    ...
    path_image, path_gt, path_intrinsic, path_depth = find_correspondent_file(20, path_root)
    ...
    print("Point number in raw point cloud: {}".format(np.asarray(pcd_filtered.points).shape[0]))
    print("Point number in raw point cloud: {}".format(np.asarray(pcd_gt.points).shape[0]))
