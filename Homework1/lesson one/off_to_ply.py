...
def write_ply_points_only_from_off(ply_data_dir, off_data_dir):
    ...
    for i in range(len(cat)):
        ...
        # 对程序进行了修改, 只处理train和test文件夹中读取的第一个.off文件
...
def main():
    # ply目标文件产生路径
    ply_data_dir = '/home/yu/3D Point Cloud Processing/DataSet/MyDataSet'
    # off文件所在路径
    off_data_dir = '/home/yu/3D Point Cloud Processing/DataSet/ModelNet40'
