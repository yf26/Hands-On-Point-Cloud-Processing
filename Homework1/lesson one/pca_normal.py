...
def main():
    ...
    # 加载原始点云
    point_cloud_pynt = PyntCloud.from_file("/home/yu/dataset/modelnet40_normal_resampled_ply/airplane/airplane_0001.ply")
    ...
    frame_points = np.append(
        [center_point],
        center_point + np.diag(200 * w / np.linalg.norm(w)).dot(v.transpose()), axis=0
    )
    frame_lines = [
        [0, 1],
        [0, 2],
