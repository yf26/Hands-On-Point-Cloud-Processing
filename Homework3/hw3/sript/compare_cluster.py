...
for i_dataset, (dataset, algo_params) in enumerate(datasets):
    ...
    params = default_base.copy()  # shallow copy, like reference, but data primitive types are deeply copied
    ...
    for name, algorithm in clustering_algorithms:
        ...
        # plot init center for debug
        if algorithm == my_kmeans or algorithm == my_gmm:
            init_center = algorithm.init_center
            plt.scatter(init_center[:, 0], init_center[:, 1], s=50, color="#000000")
