...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='2020-06-27_22-30', help='Experiment root')
...
def main(args):
    ...
    with torch.no_grad():
        ...
        log_string('Test Instance Accuracy: %f, Class Accuracy: %f' % (float(instance_acc), float(mean_class_acc)))
